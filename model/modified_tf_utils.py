""" Borrowed from: https://github.com/zhedongzheng/finch/blob/4a15484975689c48b4d5c5f7998e4c6b38965afc/nlp-models/tensorflow/toward_control/utils/modified.py
...
# 将训练过程中decoder的每一步的输入，都concat上一个向量
class ModifiedBasicDecoder(tf.contrib.seq2seq.BasicDecoder):
	def __init__(self, cell, helper, initial_state, concat_z, output_layer):
